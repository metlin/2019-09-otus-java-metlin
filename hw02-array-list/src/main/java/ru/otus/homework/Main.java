...
public class Main {
    public static void main(String[] args) {
        ...
        Collections.addAll(arrayList, "11", "22", "33", "44", "55","66","77","88","99","10","20","30","40","50","60","70","80",
                "90","1","2","3","4","5","6","7","8");
        ...
        Collections.addAll(integers, 23, 15, 254, 621, 687, 23, 1876, 724, 711, 62, 587, 943, 2111, 297, 354, 323, 25, 452, 122, 253);
        Collections.copy(integerList, integers);

        Collections.sort(integerList, Comparator.comparingInt(o -> o));
