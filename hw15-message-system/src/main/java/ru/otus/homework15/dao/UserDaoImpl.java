...
import ru.otus.homework15.hibernate.HibernateUtils;
import ru.otus.homework15.hibernate.sessionmanager.DatabaseSessionHibernate;
import ru.otus.homework15.hibernate.sessionmanager.SessionManager;
import ru.otus.homework15.hibernate.sessionmanager.SessionManagerHibernate;
...
public class UserDaoImpl implements UserDao {
    ...
    public UserDaoImpl() {
        SessionFactory sessionFactory = HibernateUtils.buildSessionFactory("WEB-INF/static/hibernate.cfg.xml", User.class);
